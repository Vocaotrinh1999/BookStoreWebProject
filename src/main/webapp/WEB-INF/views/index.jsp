				...
				<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img alt="product image"  src="<c:url value="${book.image }" />" /></a>
								<a class="second__img animation1" href="single-product.html"><img alt="product image"  src="<c:url value="${book.image }" />" /></a>
								<div class="hot__box">
								...
								<div class="action">
									<div class="actions_inner">
										<ul class="add_to_links">
											<li><a class="cart" href="#" id="${book.id }"><i class="bi bi-shopping-bag4"></i></a></li>
			...
			<div class="container">
				...
				<div class="product product__style--3">
							<div class="product__thumb">
								...
								<a class="second__img animation1" href="single-product/${id}"><img alt="product image"  src="<c:url value="${book.image }" />" /></a>
								<div class="hot__box">
									<span class="hot-label">${book.name }</span>
								</div>
							</div>
				...
				<ul class="wn__pagination">
	        		<li class="active"><a href="#" id="page">1</a></li>
	        		<li><a href="#">2</a></li>
	        		<li><a href="#">3</a></li>
	        		<li><a href="#">4</a></li>
	        		<li><a href="#">5</a></li>
